  ...
  return (
    <fieldset className="group" disabled={disabled}>
      <label className="font-semibold text-lg ">
        {field.title}
        <textarea
          className="mt-1 block w-full px-3 py-2 font-normal bg-white border border-slate-300 rounded-md text-base shadow-sm placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-blue-600"
          rows={5}
          name={field.slug}
